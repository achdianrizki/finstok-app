<script>
    $(document).ready(function() {
        ...
        function fetchitems(page, searchQuery = '') {
            ...
            $.ajax({
                url: '/return-purchase-data?page=' + page + '&search=' + searchQuery,
                method: 'GET',
                    ...
                    if (response.data.length === 0) {
                        ...
                        $.each(response.data, function(index, purchase) {
                            ...
                            <tr class="border dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-slate-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <x-button target="" href="/manager/return/purchase/${purchase.id}" variant="primary" size="sm" class="justify-center max-w-sm gap-2">
                                        Lihat
                                    </x-button>
