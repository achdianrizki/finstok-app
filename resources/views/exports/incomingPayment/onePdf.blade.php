...
<body>
    <div class="header">Pembayaran {{ $incomingPayment->sale->sale_number }}</div>
    <table class="table-head">
        <tr>
            <td>Nomor Penjualan</td>
            <td>: {{ $incomingPayment->sale->sale_number }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Pelanggan</td>
            <td>: {{ $incomingPayment->sale->buyer->name }}</td>
        </tr>
        <tr>
            <td>Sales</td>
            <td>: {{ optional($incomingPayment->sale->salesman)->name }}</td>
        </tr>
        <tr>
            <td>Pajak</td>
            <td>: Rp {{ number_format($incomingPayment->sale->tax, 2, ',', '.') }}</td>
        </tr>
        <tr>
            <td>Status</td>
            <td>: {{ $incomingPayment->sale->status == 'lunas' ? 'Lunas' : 'Belum lunas' }}</td>
        </tr>
    </table>
