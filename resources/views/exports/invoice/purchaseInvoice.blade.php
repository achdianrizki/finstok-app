...
<head>
    ...
    <title>PURCHASE ONE ON ONE</title>
    <style>
        body {
...
<body>
                ...
                <table class="table" style="width: 280px; margin-top: -2px;">
                    ...
                    <tr>
                        ...
                        <td style="width: 50%;">
                            ...
                            <p style="text-align: right;">{{ $purchase->sale_number }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%;">
                    ...
                    <tr>
                        <td style="width: 50%;">
                            ...
                            <p style="text-align: right;">{{ $purchase->salesman?->name ?? '' }}</p>
                        </td>
                        <td style="width: 50%;">
    ...
    <table class="table" style="margin-top: 5px">
        ...
        <tr>
            ...
            <td style="text-align: right; padding: 3px;"> {{ $purchase->items->sum('pivot.qty') }}</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
    ...
    <table class="table" style="margin-top: -1px">
        <tr>
            ...
            <td style="width: 170px; border-left: none">
                <div class="total-section">
                    <p style="text-align: right; margin-top: -2px;">Rp
                        {{ number_format($purchase->sub_total, 2, ',', '.') }}</p>
                    <p style="text-align: right;">Rp {{ number_format($purchase->total_discount1, 2, ',', '.') }}</p>
                    <p style="text-align: right;">Rp {{ number_format($purchase->total_discount2, 2, ',', '.') }}</p>
                    <p style="text-align: right;">Rp {{ number_format($purchase->total_discount3, 2, ',', '.') }}</p>
                    <p style="text-align: right;">Rp {{ number_format($purchase->tax, 2, ',', '.') }}</p>
                    <p style="text-align: right;">Rp {{ number_format($purchase->total_price, 2, ',', '.') }}</p>
                </div>
            </td>
        </tr>
    </table>
