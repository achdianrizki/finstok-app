<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <h2 class="text-xl font-semibold leading-tight">
                @section('title', __('Laporan Retur Penjualan'))
                {{ __('Laporan Retur Penjualan') }}
            </h2>
        </div>
    </x-slot>
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <div class="flex flex-col md:flex-row md:justify-between gap-4 my-3">
            <x-dropdown.dropdown>
                ...
                <x-slot name="menu">
                    <a href="{{ route('manager.report.return-sale-items-report.export.pdf') }}"
                    ...
                    <a href="{{ route('manager.report.return-sale-items-report.export.excel') }}"
    ...
    @push('scripts')
        ...
        @include('components.js.dtReportReturnSale')
    @endpush
