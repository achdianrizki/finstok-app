    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <form action="{{ route('manager.supplier.store') }}" method="POST">
            ...
            <div class="space-y-2">
                ...
                <x-form.input id="discount1" class="block w-full" type="text" name="discount1" :value="old('discount1')"
                ...
                <x-form.input id="discount2" class="block w-full" type="text" name="discount2" :value="old('discount2')"
