<x-app-layout>
  <x-slot name="header">
      <div class="flex items-center gap-4">
          <x-button target="" href="{{ route('manager.warehouse.index') }}" variant="primary" size="sm" class="justify-center gap-2">
  ...
  <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
      <form action="{{ route('manager.warehouse.store') }}" method="POST">
          @csrf
